...
| 5 | 10.11.2025 | working with [linguistics papers](resources/papers.md) (1): AI as a tool // identification of various challenges<br> vector semantics, words as vectors, cosine similarity, TF-IDF| [Jurafsky & Martin (2024: 121-130)](https://github.com/Tools-for-Natural-Language-Processing/tools-course-material/blob/main/JurafskyMartin_2024.pdf) <br> [More on dense embeddings](https://jalammar.github.io/illustrated-word2vec/)|
...
| 9 | 08.12.2025 | [Karpathy part 3](https://youtu.be/7xTGNNLPyMI?si=LrctojjKaEZYB_g6&t=7648) (2:07:28 -- end): reinforcement learning, big picture| linguistics papers (reporting various challenges) <br> [On the Biology of an LLM](https://transformer-circuits.pub/2025/attribution-graphs/biology.html#introduction) (Christmas fun)|
